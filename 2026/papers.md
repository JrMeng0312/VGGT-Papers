...
#### [1] GPA-VGGT: Adapting VGGT to Large Scale Localization by Self-Supervised Learning with Geometry and Physics Aware Loss
...
#### [2] VGGT-SLAM 2.0: Real-time Dense Feed-forward Scene Reconstruction
...
#### [3] VGG-T3: Offline Feed-Forward 3D Reconstruction at Scale
...
#### [4] VGGT-Det: Mining VGGT Internal Priors for Sensor-Geometry-Free Multi-View Indoor 3D Object Detection
...
#### [5] Speed3R: Sparse Feed-forward 3D Reconstruction Models
...
#### [6] VGGT-World: Transforming VGGT into an Autoregressive Geometry World Model
...
#### [7] PanoVGGT: Feed-Forward 3D Reconstruction from Panoramic Imagery
...
#### [8] HD-VGGT: High-Resolution Visual Geometry Transformer
...
#### [10] VGGT-Geo: Probabilistic Geometric Fusion of Visual Geometry Grounded Transformer Priors for Robust Dense Indoor SLAM
...
#### [11] OV3DSeg-VGGT: Open-Vocabulary 3D Segmentation with Visual Geometry-Grounded Transformers
...
#### [12] Fast vision-based 3D reconstruction and damage detection of building structures based on visual geometry grounded transformer
...
#### [13] Zero-shot text-to-3D-object generation with visual-geometry-grounded transformer
