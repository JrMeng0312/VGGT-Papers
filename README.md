...
- **2024**
  ...
  - [[CVPR](./2024/CVPR.md)] (2 篇)
    [[ECCV](./2024/ECCV.md)] (1 篇)
    [[NeurIPS](./2024/NeurIPS.md)] (1 篇)
    [[Preprint](./2024/Preprint.md)] (3 篇)
...
#### [8] PAGE-4D: Disentangled Pose and Geometry Estimation for VGGT-4D Perception
...
#### [9] DriveVGGT: Calibration-Constrained Visual Geometry Transformers for Multi-Camera Autonomous Driving
...
#### [10] VGGT-SLAM: Dense RGB SLAM Optimized on the SL(4) Manifold
...
#### [11] VGGT-SLAM 2.0: Real-time Dense Feed-forward Scene Reconstruction
...
#### [13] VGGT-X: When VGGT Meets Dense Novel View Synthesis
...
#### [14] Reloc-VGGT: Visual Re-localization with Geometry Grounded Transformer
...
#### [16] VGGT-World: Transforming VGGT into an Autoregressive Geometry World Model
...
#### [17] VGGT-Mapping: A Mapping System for Robot Navigation based on VGGT
...
#### [18] VGGT-Geo: Probabilistic Geometric Fusion of VGGT Priors for Robust Dense Indoor SLAM
...
#### [19] OV3DSeg-VGGT: Open-Vocabulary 3D Segmentation with Visual Geometry-Grounded Transformers
...
#### [20] Fast vision-based 3D reconstruction and damage detection based on VGGT
...
#### [21] Zero-shot text-to-3D-object generation with VGGT
...
#### [22] DUSt3R: Geometric 3D Vision Made Easy
...
#### [13] MASt3R: Grounding Image Matching in 3D
...
#### [14] MASt3R-SfM: a Fully-Integrated Solution for Unconstrained Structure-from-Motion
...
#### [16] CUT3R: Continuous 3D Perception Model with Persistent State
...
#### [17] Fast3R: Towards 3D Reconstruction of 1000+ Images in One Forward Pass
...
#### [18] Spann3R: 3D Reconstruction with Spatial Memory
...
- **📝 说明**：空间记忆机制，在全局坐标系中直接生成点图

#### [19] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [20] AMB3R: Accurate Feed-forward Metric-scale 3D Reconstruction with Backend
- **🧑‍🔬 作者**：Hengyi Wang, Lourdes Agapito
- **🏫 单位**：UCL (University College London)
...
#### [21] MoGe: Unlocking Accurate Monocular Geometry Estimation for Open-Domain Images with Optimal Training Supervision
...
#### [22] Depth Anything 3: Recovering the Visual Space from Any Views
...
#### [23] Review of Feed-forward 3D Reconstruction: From DUSt3R to VGGT
