...
| [TTT 与长序列重建](#ttt-与长序列重建) | VGG-T³, TTT3R, tttLRM, ZipMap, Scal3R, InfiniteVGGT, LoGeR, Test3R 等 |
...
#### [2] SwiftVGGT: A Scalable Visual Geometry Grounded Transformer for Large-Scale Scenes
...
#### [4] HD-VGGT: High-Resolution Visual Geometry Transformer
...
#### [5] PanoVGGT: Feed-Forward 3D Reconstruction from Panoramic Imagery
...
#### [6] Faster VGGT with Block-Sparse Global Attention
...
#### [7] QuantVGGT: Quantized Visual Geometry Grounded Transformer
...
#### [9] VGGT-SLAM 2.0: Real-time Dense Feed-forward Scene Reconstruction
...
#### [11] PAGE-4D: Disentangled Pose and Geometry Estimation for VGGT-4D Perception
...
#### [12] DriveVGGT: Calibration-Constrained Visual Geometry Transformers for Multi-Camera Autonomous Driving
...
#### [15] GPA-VGGT: Adapting VGGT to Large Scale Localization by Self-Supervised Learning with Geometry and Physics Aware Loss
...
#### [16] VGGT-Det: Mining VGGT Internal Priors for Sensor-Geometry-Free Multi-View Indoor 3D Object Detection
...
#### [17] VGGT-World: Transforming VGGT into an Autoregressive Geometry World Model
...
#### [18] VGGT-Mapping: A Mapping System for Robot Navigation based on VGGT
...
#### [19] VGGT-Geo: Probabilistic Geometric Fusion of VGGT Priors for Robust Dense Indoor SLAM
...
#### [20] OV3DSeg-VGGT: Open-Vocabulary 3D Segmentation with Visual Geometry-Grounded Transformers
...
#### [21] Fast vision-based 3D reconstruction and damage detection based on VGGT
...
#### [22] Zero-shot text-to-3D-object generation with VGGT
...
- **📝 说明**：测试时自监督优化几何一致性，通用适用、近乎零成本的测试时学习技术
