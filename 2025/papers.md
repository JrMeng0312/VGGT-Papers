...
#### [1] MoGe: Unlocking Accurate Monocular Geometry Estimation for Open-Domain Images with Optimal Training Supervision
...
#### [2] CUT3R: Continuous 3D Perception Model with Persistent State
...
#### [3] Fast3R: Towards 3D Reconstruction of 1000+ Images in One Forward Pass
...
#### [6] VGGT-SLAM: Dense RGB SLAM Optimized on the SL(4) Manifold
...
#### [8] FastVGGT: Training-Free Acceleration of Visual Geometry Transformer
...
#### [9] Faster VGGT with Block-Sparse Global Attention
...
#### [10] QuantVGGT: Quantized Visual Geometry Grounded Transformer
...
#### [12] TTT3R: 3D Reconstruction as Test-Time Training
...
- **📝 说明**：🏆 ICLR 2026 — 闭式学习率推导，免训练干预，全局位姿估计提升 2 倍

#### [13] PAGE-4D: Disentangled Pose and Geometry Estimation for VGGT-4D Perception
...
#### [15] SwiftVGGT: A Scalable Visual Geometry Grounded Transformer for Large-Scale Scenes
...
#### [16] AMB3R: Accurate Feed-forward Metric-scale 3D Reconstruction with Backend
...
#### [17] DriveVGGT: Calibration-Constrained Visual Geometry Transformers for Multi-Camera Autonomous Driving
...
#### [18] Reloc-VGGT: Visual Re-localization with Geometry Grounded Transformer
...
#### [19] VGGT-Mapping: A Mapping System for Robot Navigation based on Visual Geometry Grounded Transformer
