# 2025 Preprint Papers

#### [1] VGGT-SLAM: Dense RGB SLAM Optimized on the SL(4) Manifold
...
#### [2] FastVGGT: Training-Free Acceleration of Visual Geometry Transformer
...
#### [3] Faster VGGT with Block-Sparse Global Attention
...
#### [4] QuantVGGT: Quantized Visual Geometry Grounded Transformer
...
#### [5] VGGT-X: When VGGT Meets Dense Novel View Synthesis
...
#### [7] SwiftVGGT: A Scalable Visual Geometry Grounded Transformer for Large-Scale Scenes
...
#### [9] AMB3R: Accurate Feed-forward Metric-scale 3D Reconstruction with Backend
...
#### [11] Depth Anything 3: Recovering the Visual Space from Any Views
