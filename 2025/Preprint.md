...
- **📝 说明**：🏆 Accepted to ICLR 2026 — 循环式状态更新，支持在线稠密重建

#### [2] VGGT-SLAM: Dense RGB SLAM Optimized on the SL(4) Manifold
...
#### [5] SwiftVGGT: A Scalable Visual Geometry Grounded Transformer for Large-Scale Scenes
...
#### [6] DriveVGGT: Calibration-Constrained Visual Geometry Transformers for Multi-Camera Autonomous Driving
...
#### [7] AMB3R: Accurate Feed-forward Metric-scale 3D Reconstruction with Backend
